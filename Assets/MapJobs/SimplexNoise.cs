...
namespace Assets.MapJobs
{
    unsafe struct SimplexNoise
    {
        ...
        private static readonly float4[] grad4 = {
        ...
        private static double dot(float3 g, double x, double y)
        {
            return g.x * x + g.y * y;
        }

        private static double dot(float3 g, double x, double y, double z)
        {
            return g.x * x + g.y * y + g.z * z;
        }

        private static double dot(float4 g, double x, double y, double z, double w)
        {
